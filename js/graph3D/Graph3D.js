class Graph3D {
    ...
    getProection(point) {
        ...
        const P2M = this.math.calcVector(M, this.WINDOW.P2);
        const cosa = this.math.calcCorner(this.P1P2, M);
        const cosb = this.math.calcCorner(this.P3P2, M);
    ...
    calcWindowVectors() {
        ...
        this.P3P2 = this.math.calcVector(this.WINDOW.P3, this.WINDOW.P2);
    }
